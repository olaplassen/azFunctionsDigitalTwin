...
namespace SampleFunctionsApp
{
    ...
    public class ProcessHubToDTEvents
    {
        ...
        public async void Run([EventGridTrigger]EventGridEvent eventGridEvent, ILogger log)
        {
            ...
            log.LogInformation("Start execution ProcessHubToDTEvents");
            ...
            if (eventGridEvent != null && eventGridEvent.Data != null)
            {
                ...
                log.LogInformation($"Device:{deviceId} Temperature is:{temperature} and Humidity is: {humidity} ProcessHubToDTEvents");
            ...
            {
                log.LogInformation($"EventgridEvent == nul or .data == null");
            }
        }
    }
}